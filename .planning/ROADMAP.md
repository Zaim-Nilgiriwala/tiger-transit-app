...
- [ ] **Phase 7: Baseline Infrastructure** - Compute historical baselines and residual labels for all data splits
- [ ] **Phase 8: Training Adaptation** - Retrain XGBoost on residual targets with fresh hyperparameter tuning
