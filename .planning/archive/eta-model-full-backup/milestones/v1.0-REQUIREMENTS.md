# Requirements Archive: v1.0 XGBoost ETA Model
...
- [x] **EVAL-01**: Metrics (MAE, RMSE, MAPE) overall and sliced by route, stops_remaining bucket, time-of-day, distance bucket
- [x] **EVAL-02**: SHAP feature importance analysis -- global TreeExplainer and sample-level explanations
- [x] **EVAL-03**: Comparison report vs schedule-based baseline (scheduled_time_to_target as naive predictor)
- [x] **EVAL-04**: Residual analysis for systematic bias detection (over/under-prediction patterns by route, time, stop type)
...
**Adjusted:** TRAIN-03 ran 50 trials (not 100-200) due to 10% subsample strategy; TRAIN-04 used P20/P50/P75 (not P50/P80)
**Dropped:** None
